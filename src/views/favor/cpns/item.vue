<template>
  <div class="item">
    ...
    <div class="cell">
      ...
      <div class="type">
        {{ info.unitSummeries[0].text }}.{{ info.unitSummeries[1].text }}
      </div>
    </div>
    ...
    <div class="cell">
      <div
        class="label"
        v-for="label in info.allActiveAndRedPacket.activeRedPacket"
        :key="label"
      >
        {{ label.title }}{{ formatDiscount(label.introduction) }}元
      </div>
    </div>
    <div class="cell">
