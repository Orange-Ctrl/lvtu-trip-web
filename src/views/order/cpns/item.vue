  ...
  <div class="item">
    <div class="item-header">
      ...
      <div
        :class="[
          'item-status',
          info.orderStatus === 1 ? 'item-status_pending' : 'item-status_cancel',
        ]"
      >
      ...
      <div class="item-content">
        <div class="start-box">
          <div class="start-date">
            {{ formatMonthDay(`${info.checkInDate}`, "M月DD日") }}
          </div>
          <div class="start-time">
            {{ formatWeekday(info.checkInDate) }}{{ info.checkInLatestTime }}
          </div>
        </div>
        <img
          class="content-icon"
        ...
        <div class="start-box end-box">
          <div class="start-date">
            {{ formatMonthDay(`${info.checkOutDate}`, "M月DD日") }}
          </div>
          <div class="start-time">
            {{ formatWeekday(info.checkOutDate) }}{{ info.checkOutLatestTime }}
          </div>
        </div>
        <div class="price-box">
